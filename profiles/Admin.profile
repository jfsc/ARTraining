...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>ConsumptionRate-Layout de Taxa de consumo</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ConsumptionSchedule-Layout de Programação de consumo</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Individual-Layout de Indivíduo</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ProductConsumptionSchedule-Layout de Programação de consumo do produto</layout>
    </layoutAssignments>
    <layoutAssignments>
